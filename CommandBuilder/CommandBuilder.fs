...
type CommandBuilder() =
    member __.For (target:Target<'T,'Q>, body: 'T -> Target<'Result,'Q2>) : Target<'Result,'Q> = 
        Target None
    member __.Zero () = 
        Target None
    ...
    member __.Insert (source: Target<'T,'Q>, target:(unit -> Table<'T>)) = () // Target<'T,'Q> None

    member __.Delete (target:Target<'T,'Q>) = () // Target<'T,'Q> None